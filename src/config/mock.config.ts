...
export const MOCK_USERS = [
  ...
  },
  {
    ...
    payment_info: {
      alipay_account: 'qianqi@alipay.com',
      alipay_qr_code: '/uploads/qr_codes/qianqi_alipay.jpg'
    }
  }
...
] as const satisfies readonly Omit<Bill, 'user'>[];
